            ...
            <div class="row">
              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h1 class="h5 text-gray-900 mb-4">Masuk</h1>
                    <hr>
                  </div>
              ...
              <?php if($this->session->flashdata('message')) { ?>
                ...
                <?= $this->session->flashdata('message'); ?>
                  ...
                  <form class="user" method="post" action="<?= base_url('adminweb/login'); ?>">
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url();?>adminweb/registration">Buat Akun Baru!</a>
                  </div>-->
                </div>
              </div>
            </div>
