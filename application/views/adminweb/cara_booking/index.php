...
<!-- Page Heading -->
<center><h1 class="h3 mb-4 text-gray-800"><b>Cara Booking</b></h1></center>
...
<?= $this->session->flashdata('message'); ?>
    ...
    <div class = "row">
		 	<div class = "col-lg-8">
				 ...
				 <?= form_open_multipart('adminweb/carabooking_simpan/'); ?>
				<input type="hidden" name='id_carabooking' value="<?php echo $id_carabooking;?>"> 
