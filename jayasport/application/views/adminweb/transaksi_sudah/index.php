        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <center><h1 class="h3 mb-4 text-gray-800"><b>Data Sudah Konfirmasi</b></h1>
...
<table class="table table-striped">
  <thead>
	...
	<tbody>
										<?php
										$no=1;
										if ($data_transaksi_sudah->num_rows()>0) {
											foreach ($data_transaksi_sudah->result_array() as $tampil) { ?>
										<tr >
											...
											<td><center>
											<a class="badge badge-success" href="<?php echo base_url();?>adminweb/transaksi_sudah_detail/<?php echo $tampil['id_transaksi'];?>"><i class="fas fa-fw fa-search"></i> Detail</a>
											<a class="badge badge-danger" href="<?php echo base_url();?>adminweb/transaksi_sudah_delete/<?php echo $tampil['id_transaksi'];?>" onclick="return confirm('Yakin Ingin Menghapus <?php echo $tampil['kode_transaksi'];?>?')"><i class="fas fa-fw fa-eraser"></i> Delete</a>
											</td>
