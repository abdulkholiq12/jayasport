<!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800"><center><b>Balas Pesan</b></h1> 
			<?php
			...
			<div class="row">
				...
				<a type="text" href="<?php echo base_url();?>adminweb/buku_tamu_kirim" class="btn btn-secondary mb-3"  data-title="Sent">Pesan Terkirim</a>
				-->
							<?php
							}
							?>
					...
					<div class="form-group row">
							...
							<div class="inbox-compose-btn">
								...
								<a href="<?php echo base_url();?>adminweb/buku_tamu/<?php echo $id_hubungikami;?>"> <button class="btn btn-secondary">Batal</button></a>	
							</div>
</div>
